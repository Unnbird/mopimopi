d = {
    ...
    fullscreen: {
        ...
        TW: "全屏模式<font class='ex'>　❙ 移動端</font>",
    },
    More: {
        KR: '더보기',
        JP: 'もっと見る',
    ...
    Capture: {
        ...
        TW: "截圖<font class='ex'>　❙ PC, ACTWebSocket</font>",
    },
    Data: {
        KR: "데이터",
        JP: "データ",
    ...
    caution_m1: {
        ...
        TW: '<br>在鍵盤輸入的情况下，<br>ACT ❯ Plugins ❯ ACTWebSocket ❯ Open Manager ❯ Preferences ❯ <font class="ac"><b>No Focus</b> 請取消勾選。</font>',
    },
    caution_m2: {
        ...
        TW: '<br>在鍵盤輸入的情况下，<br>ACT ❯ Plugins ❯ ACTWebSocket ❯ Open Manager ❯ Preferences ❯ <font class="ac"><b>No Focus</b> 請取消勾選。</font><br><br><font class="ac">❖ 移動端不支持此功能。<br>❖ 您只能輸入字體名稱。 (除字體樣式外)<br>❖ 如果字體文損壞或者不存在，則使用默認字體。</font>',
    },
    input_font: {
        m: {
            KR: "글꼴 이름",
    ...
    jobIcon: {
        ...
        TW: "圖標<font class='ex'>　❙ 玩家職業圖標</font>",
    },
    rps: {
        KR: "데이터",
        JP: "データ",
    ...
    graph_user: {
        ...
        TW: "用户<font class='ex'>　❙ 極限技，陸行鳥等</font>",
    },
    graph_pet: {
        ...
        TW: "召喚物<font class='ex'>　❙ 召喚物與自身數據合併 'ON'</font>",
    },
    graph_shield: {
        KR: "D.Shield",
        JP: "D.Shield",
    ...
    duration: {
        ...
        m: {
            ...
            TW: "戰鬥日志收集時间<br><span class='ac'> = 自己開始攻擊時</span>",
        },
        e: "li_2line_checkbox",
        ul: 1
    },
    dps: {
        ...
        m: {
            ...
            TW: "每秒傷害<br><span class='ac'> = 戰鬥总傷害除以個人戰鬥時间</span>",
        },
        e: "li_2line_checkbox",
        ul: 0
    },
    EncounterDuration: {
        ...
        m: {
            ...
            TW: "戰鬥日志收集時间<br><span class='ac'> = 隊伍開始攻擊時</span>",
        },
        e: "li_2line_checkbox",
        ul: 0
    },
    encdps: {
        ...
        m: {
            ...
            TW: "每秒傷害<br><span class='ac'> = 戰鬥总傷害除以戰鬥時间</span>",
        },
        e: "li_2line_checkbox",
        ul: 0
    },
    rdps: {
        ...
        m: {
            ...
            JP: "レイドバフの寄与を精算したDPS",
            EN: "Damage per second with other players' raid buff contributions handed back to them, and your own contributions to others added in.",
    ...
    adps: {
        ...
        m: {
            ...
            EN: "Raw damage per second, raid buffs included. Should track the DPS column - a mismatch means FFLogs and ACT disagree.",
            ...
            CN: "含团辅的实际每秒伤害，用于与 DPS 栏对照",
            TW: "含團輔的實際每秒傷害，用於與 DPS 欄對照",
        },
        e: "li_2line_checkbox",
        ul: 0
    },
    ndps: {
        ...
        m: {
            ...
            EN: "Own damage only, with every external buff contribution stripped out. Shows how well the rotation was executed.",
            ...
            CN: "剔除所有外部增益后的纯自身 DPS",
            TW: "剔除所有外部增益後的純自身 DPS",
        },
        e: "li_2line_checkbox",
        ul: 0
    },
    cdps: {
        ...
        m: {
            ...
            EN: "Everything except single-target padding: buffs given and AOE buffs received both count.",
            ...
            CN: "除单体增益外全部计入：给出的与收到的团辅都算",
            TW: "除單體增益外全部計入：給出的與收到的團輔都算",
        },
        e: "li_2line_checkbox",
        ul: 0
    },
    ...
    rdpsDelta: {
        ...
        m: {
            ...
            EN: "rDPS minus aDPS. Positive means this player gave more raid buff value than they received.",
            FR: "rDPS moins aDPS. Positif = ce joueur a donné plus qu'il n'a reçu.",
            DE: "rDPS minus aDPS. Positiv = mehr gegeben als erhalten.",
            CN: "rDPS 减 aDPS。为正代表给出的团辅收益多于收到的",
            TW: "rDPS 減 aDPS。為正代表給出的團輔收益多於收到的",
        },
        e: "li_2line_checkbox",
        ul: 0
    },
    ...
    mergedSwings: {
        ...
        m: {
            ...
            TW: "攻擊次數<br><span class='ac'> = 包含自動攻擊，DOT，技能，以及沒有傷害的無效攻擊。</span>",
        },
        e: "li_2line_checkbox",
        ul: 1
    },
    ...
    hitfailed: {
        ...
        m: {
            ...
            TW: "攻擊失敗次數<br><span class='ac'> = 包括目標的抵抗，反射，阻擋，回避等</span>",
        },
        e: "li_2line_checkbox",
        ul: 0
    },
    ...
    enchps: {
        ...
        m: {
            ...
            TW: "每秒療傷<br><span class='ac'> = 治療总量除以戰鬥時间</span>",
        },
        e: "li_2line_checkbox",
        ul: 1
    },
    ...
    mergedHeals: {
        ...
        m: {
            ...
            TW: "治療次數<br><span class='ac'> = 包含HOT，技能等</span>",
        },
        e: "li_2line_checkbox",
        ul: 1
    },
