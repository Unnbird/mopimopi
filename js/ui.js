...
function addOption() {
    var qVal = ['bar_position_DPS', 'mhh_unit', 'dmgType', 'view24_Number', 'time_italic', 'target_italic', 'rps_italic', 'header_italic', 'body_italic', 'iconSet', 'borderTextType', 'max_unit', 'act_md', 'act_mh', 'unit_ns', 'sortDPS', 'sortHPS', 'sortDescDPS', 'sortDescHPS', 'fflogs']
